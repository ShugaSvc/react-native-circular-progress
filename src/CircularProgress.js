    ...
    render() {
        ...
        return (
            <View style={[style]}>
                ...
                >
                    <Defs>
                        <LinearGradient id="grad" x1="0" y1="0" x2="0" y2={size}>
                            <Stop offset="0" stopColor={tintLinearGradientColors ? tintLinearGradientColors[0] : tintColor} stopOpacity="1" />
                            <Stop offset="1" stopColor={tintLinearGradientColors ? tintLinearGradientColors[1] : tintColor} stopOpacity="1" />
                        </LinearGradient>
                    </Defs>
